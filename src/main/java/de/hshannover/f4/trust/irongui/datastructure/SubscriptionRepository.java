...
public class SubscriptionRepository {
	...
	public void addSubscription(Connection con, IdentifierData ident) {
		String uuid = CryptoUtil.generateMd5BySize(ident.getRequestObject()
				.toString(), 16);
	...
	public IdentifierData getIdentifierDataBySubscriptionName(Connection con,
			String uuid) {
		HashMap<String, IdentifierData> map = mSubscriptions.get(con);
		if (map != null) {
			return map.get(uuid);
	...
	public String getSubscriptionNameByIdentifier(Connection con,
			IfmapDataType ident) {
		String name = null;
		HashMap<String, IdentifierData> map = mSubscriptions.get(con);
		if (map != null) {
